...
public interface EnderecoRepository extends JpaRepository<Endereco, Integer> {
    ...
    @Query("""
            ...
            where e.id = ?8""")
    Integer updateEndereco(String logradouro, String numero, String complemento, String bairro, String cidade, String estado, String cep, Integer id);
    ...
    Integer deleteEnderecoById(Integer id);
